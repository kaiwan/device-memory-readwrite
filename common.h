...
#define MIN_LEN_IOPORT 		1
#define MAX_LEN_IOPORT		64*1024
...
const char usage_warning_msg[] = "NOTE: You MUST realize that providing an invalid address or IO port, or \
